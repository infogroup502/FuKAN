...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_size', type=list, default=[3])
    parser.add_argument('--global_size', type=list, default=[5])
    parser.add_argument('--anormly_ratio', type=float, default=0.61)
    ...
    parser.add_argument('--input_c', type=int, default=86)
    parser.add_argument('--output_c', type=int, default=86)
    parser.add_argument('--dataset', type=str, default='HAI')
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'test'])
    parser.add_argument('--data_path', type=str, default='HAI')
    ...
    sys.stdout = Logger("result/" + f"result_{config.data_path}" + ".log", sys.stdout)
